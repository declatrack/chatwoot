class SearchService
  ...
  def filter_conversations
    ...
    # Restringe visibilidade baseado nas mesmas regras de team/assignment da listagem de conversas
    conversations_query = Conversations::PermissionFilterService.new(
      conversations_query, current_user, current_account
    ).perform
