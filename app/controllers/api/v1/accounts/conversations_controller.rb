class Api::V1::Accounts::ConversationsController < Api::V1::Accounts::BaseController
  ...
  before_action :ensure_assignee_or_admin, only: [:toggle_status, :update_last_seen]
  ...
  def ensure_assignee_or_admin
    ...
    render json: { error: 'You must be assigned to this conversation to change its status' }, status: :forbidden
  end
end
